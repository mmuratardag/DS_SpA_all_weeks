...
if __name__ == "__main__":
    ...
    logging.critical("Tweet collector is ALIVE")

    client = pymongo.MongoClient(host="mongodb", port=27017)
    db = client.tweets
    collection = db.tweet_data

    twitter_streamer = TwitterStreamer(["politics"])
    ...
    while times_to_repeat >= 0:
        ...
        logging.critical('streaming 10 tweets, times to repeat left = {}'.format(times_to_repeat))
        time.sleep(2)

logging.critical('Tweet collecter KILLED itself after 10 runs')
